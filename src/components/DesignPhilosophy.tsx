      ...
      <div className="px-[5%] max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        >
          <motion.img
            ...
            alt="Filosofía de diseño Forma Studio"
        ...
        <div>
          ...
          >
            Cada proyecto comienza con una conversación. Escuchamos, observamos y traducimos
            deseos en espacios que reflejan la identidad de quienes los habitan. No seguimos
            fórmulas; diseñamos experiencias.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Trabajamos con materiales nobles, luz natural y proporciones que generan calma.
            La funcionalidad y la estética no compiten — conviven en cada decisión.
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
